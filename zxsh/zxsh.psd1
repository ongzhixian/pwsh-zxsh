...
FunctionsToExport = @("Set-Title", "Prompt", "Get-Secrets", "Get-Secret", "Add-Secret", "Update-Secret", "Remove-Secret")
...
FileList = @('zxsh.psm1', 'zxsh-default.ps1', 'zxsh-hashtable.ps1',  'zxsh-secrets.ps1')
